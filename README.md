...
Acessibility means that the webpage is designed that people with disabilities can use, navigate, interact, and understand what is on the page.
...
variables are used to label and store information. They can be referenced and manipulated throughout a program.

4. What is the purpose of using functions in code?

functions are a small snippet of code that performs a specific task.

They allow us to reuse code. Once a function is defined it can be reused.

Can test small parts of the program, separate from everything else.

Variable names dont get messy if you use local variables.
